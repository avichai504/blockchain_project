...
while (!mempool.isEmpty()) {
  ...
  txBatch.forEach(tx => {
    ...
    // סטטיסטיקה
    totalBurned += 2; // baseFee שנשרף
    totalRewarded += 3; // priorityFee שניתן לכורה
...
// light wallets מקבלים רק טרנזקציות שרלוונטיות
...
// בדיקה של טרנזקציה ב-Light Wallet
